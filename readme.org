...
Category Theory is considered by many to be an involved subject to get into. It becomes a ground for unification of interdisciplinary mathematical ideas; and the way it achieves this is by taking an abstract vantage point on the concepts, properties, rules and processes of these disciplines. The level of abstraction acts as a rigorous ground for reasoning precisely about a huge gamut of patterns happening in distinct domains. This abstract vantage point provides a toolkit to examine the universal properties happening across its domains of study. 
