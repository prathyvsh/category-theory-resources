...
<img width="300px" align="left" src="./img/seven-sketches-in-compositionality.jpg" />
...
<img width="300px" align="left" src="./img/algebra-chapter-0.png" />
<p>Paulo Aluffi</p>
#+END_HTML

#+BEGIN_HTML
<h2><a href="https://amzn.to/2zjvbli">Conceptual Mathematics: A First Introduction to Categories</a></h2>
<img width="300px" align="left" src="./img/conceptual-mathematics.jpg" />
